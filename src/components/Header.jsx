...
const Header = () => {
  ...
  return (
    <header className="bg-gray-50 dark:bg-black w-[90%] mx-auto border h-20  rounded-none flex items-center justify-between px-5 fixed top-10 left-1/2 -translate-x-1/2 z-100" style={{
      ...
      <div className="flex items-center gap-8 uppercase">
        ...
        <div className="p-3 bg-gray-200 dark:bg-black rounded-none">
      ...
      <Link className={getLinkClasses("/")} style={{fontWeight: 700}} to="/">Home</Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            <a 
              ...
              className="p-2 rounded-none hover:bg-gray-200 icon dark:hover:bg-gray-700 transition-colors"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="p-2 rounded-none hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
            >
          ...
          <button 
            ...
            className="font-bold text-xs md:text-sm w-[200px] rounded-none md:w-[160px] py-5 md:py-4 rounded-none cursor-pointer bg-black text-white uppercase hover:bg-black transition-colors dark:bg-white dark:text-black dark:hover:bg-gray-200"
          >
            Login
          </button>
        </div>
