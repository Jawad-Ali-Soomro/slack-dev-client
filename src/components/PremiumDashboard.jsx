  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center p-8">
        <div className="animate-spin rounded-[15px] h-8 w-8 border-b-2 border-orange-500"></div>
      </div>
    );
  }
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-r from-orange-500 to-red-500 rounded-[15px] flex items-center justify-center">
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        {Icon && (
                          <Icon className="w-5 h-5 icon text-gray-600 dark:text-gray-400" />
                        )}
                      ...
                      {isAtLimit && (
                        <XCircle className="w-4 h-4 icon icon text-red-500" />
                      )}
                      {isNearLimit && !isAtLimit && (
                        <AlertTriangle className="w-4 h-4 icon icon text-yellow-500" />
                      )}
                    </div>
