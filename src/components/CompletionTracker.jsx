...
const CompletionTracker = ({
  ...
  const getCompletionBadge = () => {
    ...
    return (
      <div className="inline-flex items-center gap-1 px-2 py-1 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 rounded-[15px] text-xs font-medium">
  ...
  const getCompletionButton = () => {
    ...
    return (
      ...
      >
        {isLoading ? (
          <div className="w-4 h-4 icon icon  border-white border-t-transparent rounded-[15px] animate-spin" />
        ) : (
          <CheckCircle className="w-4 h-4 icon icon" />
        )}
        Mark Complete
