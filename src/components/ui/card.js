...
function Card(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ "data-slot": "card", className: (0, utils_1.cn)("bg-card text-card-foreground  flex flex-col gap-6 rounded-[10px] py-6 bg-gray-100 dark:bg-black", className) }, props)));
}
...
function CardTitle(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)("div", __assign({ "data-slot": "card-title", className: (0, utils_1.cn)("leading-none ", className) }, props)));
}
