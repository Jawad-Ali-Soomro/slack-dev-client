    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="absolute -top-1 -right-1 w-5 h-5 bg-red-500 rounded-lg text-[10px] text-white flex items-center justify-center">
        ...
        <div className="max-h-96 overflow-y-auto">
          {loading ? (
            <div className="p-4 text-center">
              <div className="animate-spin rounded-lg h-6 w-6 border-b-2 border-gray-900 dark:border-white mx-auto"></div>
