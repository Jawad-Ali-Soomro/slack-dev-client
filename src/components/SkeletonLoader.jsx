...
const SkeletonLoader = ({ type = 'card', count = 1, className = '' }) => {
  ...
  const CardSkeleton = () => (
    <div className="bg-white dark:bg-black rounded-[10px] border-2 border-gray-200 dark:border-gray-700 p-6 animate-pulse">
  ...
  const TableSkeleton = () => (
    <div className="bg-white dark:bg-black rounded-[10px] shadow-xl border-2 border-gray-200 dark:border-gray-700 overflow-hidden animate-pulse">
  ...
  const ListSkeleton = () => (
    <div className="space-y-4">
      {Array.from({ length: count }).map((_, index) => (
        <div key={index} className="bg-white dark:bg-black rounded-[10px] border-2 border-gray-200 dark:border-gray-700 p-4 animate-pulse">
