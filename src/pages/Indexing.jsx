  ...
  useGSAP(
    () => {
      ...
      heroTl
        ...
        .from(".hero-badge", { scale: 0.8, opacity: 0, duration: 0.5 }, "-=0.4")
        .from(
          ".hero-line",
    ...
    <>
      ...
      >
        ...
        <div className="hero-cta flex flex-col sm:flex-row gap-4 mt-10">
          <button
            className="landing-btn-primary group relative w-[200px] py-4 bg-black text-white font-bold rounded-2xl text-sm cursor-pointer overflow-hidden dark:bg-white dark:text-black"
          ...
          <button
            className="landing-btn-secondary w-[200px] py-4 font-bold rounded-2xl text-sm cursor-pointer border border-black/10 dark:border-white/20 text-gray-800 dark:text-white backdrop-blur-sm hover:bg-black/5 dark:hover:bg-white/5 transition-colors"
        ...
        {/* Dashboard mockup */}
        <div className="hero-mockup mt-16 w-full max-w-7xl border-none">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl overflow-hidden">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-4">
                {[
                  ...
                  <div
                    key={card.title}
                    className={`landing-stat-chip ${card.accent ? "landing-stat-chip--accent" : ""}`}
                  >
                    <div className="landing-stat-chip__top">
                      <div>
                        <div className="landing-stat-chip__title">
                          {card.title}
                        </div>
                        <div className="landing-stat-chip__sub">
                          {card.subtitle}
                        </div>
                      </div>
                      <div className="landing-stat-chip__icon">{card.icon}</div>
                    </div>
                    <div className="landing-stat-chip__bottom">
                      <span className="landing-stat-chip__value">
                        {card.value}
                      </span>
                      {card.trend && (
                        <span className="landing-stat-chip__trend">
                          ↑ {card.trend}
                        </span>
                      )}
                    </div>
              ...
              <div className="px-4 pb-5">
                <div className="rounded-2xl border border-gray-100 dark:border-white/10 bg-gray-50/80 dark:bg-white/[0.03] p-4">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-9 h-9 rounded-xl bg-theme flex items-center justify-center text-white shrink-0">
                      <Activity size={16} />
                    </div>
                  ...
                  <WeeklyBarChart compact height={200} animate />
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Marquee */}
      <div
        className="w-full py-6 border-y border-black/5 dark:border-white/10 overflow-hidden relative z-10"
        data-section
      >
      ...
      {/* How It Works */}
      <section
        className="w-full max-w-5xl mx-auto px-6 py-24 relative z-10"
        data-section
      >
        <div className="text-center mb-16" data-reveal>
          <span className="text-xs uppercase tracking-widest text-theme font-bold">
      ...
      {/* Final CTA */}
      <section className="w-full relative z-10 py-24 px-6" data-section>
