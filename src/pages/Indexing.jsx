...
{floatingIcons.map(({ Icon, color, top, left, right, delay }, index) => (
          ...
          >
            ...
            <motion.span 
              ...
              className="p-3 text-[9px] font-bold bg-gray-200 dark:bg-gray-700 text-black dark:text-white rounded-none px-5 "
            >
            ...
            >
                <motion.button 
                  className="w-[300px] font-bold py-4 bg-black text-white z-50 rounded-none text-sm cursor-pointer hover:bg-black transition-colors shadow-lg dark:bg-white dark:text-black dark:hover:bg-gray-200"
                  whileTap={{ scale: 0.95 }}
            ...
            >
                ...
                <motion.div 
                  ...
                  whileHover={{ scale: 1.05 }}
                >
                    <span className="w-2 h-2 bg-purple-500 rounded-none"></span>
                    Setup in Minutes
                </motion.div>
            </motion.div>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            {[
              ...
              <motion.div
                key={index}
                className="p-8 bg-white dark:bg-black rounded-none shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden"
              ...
              >
                ...
                <div className="w-[80px] h-[80px] bg-[rgba(0,0,0,0.1)] rounded-none flex items-center justify-center mb-4 dark:bg-[rgba(255,255,255,0.1)]">
                ...
                <button className="text-[10px] font-bold text-white  leading-relaxed w-[50px] h-12 bg-black border-black dark:border-white rounded-none mt-4 flex items-center justify-center dark:bg-white dark:text-black" style={{
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                key={index}
                className="p-8 glass-card rounded-none relative overflow-hidden"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div className="flex items-center">
                  <img 
                    ...
                    className="w-12 h-12 rounded-none mr-4 object-cover"
                  />
                  <div>
...
How It Works
        ...
        >
          <div className="max-w-4xl mx-auto text-center px-6">
            ...
            <motion.button 
              className="w-[400px] font-bold py-4 bg-white text-black rounded-none text-lg  transition-colors shadow-lg dark:bg-white dark:text-black "
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
