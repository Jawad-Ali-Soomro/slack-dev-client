...
const Projects = () => {
  ...
  const isProjectOwner = (project) => {
    return (
      project.createdBy?.id === user?.id || project.createdBy?._id === user?.id
    );
  };
  ...
  const getPriorityIcon = (priority) => {
    switch (priority) {
      case "low":
        return <ArrowDown className="w-3 h-3 icon icon" />;
      case "medium":
        return <Minus className="w-3 h-3 icon icon" />;
      case "high":
        return <ArrowUp className="w-3 h-3 icon icon" />;
      case "urgent":
        return <AlertTriangle className="w-3 h-3 icon icon" />;
      default:
        return <Minus className="w-3 h-3 icon icon" />;
    }
  };
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case "on_hold":
        return <Pause className="w-4 h-4 icon icon icon" />;
      case "completed":
        return <CheckCircle className="w-4 h-4 icon icon icon" />;
      case "cancelled":
        return <X className="w-4 h-4 icon icon icon" />;
      default:
        return <Clock className="w-4 h-4 icon icon icon" />;
    }
  };
