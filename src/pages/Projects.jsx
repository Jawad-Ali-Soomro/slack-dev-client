      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            className={'w-[200px] rounded-none rounded-none h-12'}
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          filteredProjects.map((project) => (
              <motion.div
                ...
                className="dark:bg-[rgba(255,255,255,.1)] rounded-none bg-white dark:border-none border  p-6 transition-shadow duration-300"
              >
                {/* Project Header */}
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      {project.logo && (
                        <img
                          ...
                          alt={project.name}
                          className="w-8 h-8 rounded object-cover rounded-none bg-gray-100  border border-gray-200 dark:border-gray-700"
                        />
                      )}
                ...
                <div className="flex gap-2 mb-4 mt-10">
                  <span className={`inline-flex items-center border gap-1 uppercase px-4 py-2 rounded-none text-[10px] font-medium ${getStatusColor(project.status)}`}>
                    {getStatusIcon(project.status)}
                    {project.status.replace('_', ' ')}
                  </span>
                  <span className={`inline-flex items-center  px-4 py-2 border uppercase rounded-none text-[10px] font-medium ${getPriorityColor(project.priority)}`}>
                    {project.priority}
                  </span>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-none h-2">
                    <div 
                      className="bg-black dark:bg-white h-2 rounded-none transition-all duration-300"
                ...
                {project.tags && project.tags.length > 0 && (
                  <div className="flex flex-wrap gap-1 mb-4">
                    {project.tags.slice(0, 3).map((tag, index) => (
                      <span
                        key={index}
                        className="inline-flex items-center px-2 py-1 bg-gray-100 dark:bg-black text-gray-700 dark:text-gray-300 rounded-none text-xs"
                      >
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex -space-x-2">
                      {project.members?.slice(0, 3).map((member, index) => (
                        <div
                          key={index}
                          className="w-10 h-10 rounded-none border-2 border-white dark:border-gray-900 overflow-hidden cursor-pointer hover:scale-110 transition-transform"
                      ...
                      {project.members?.length > 3 && (
                        <div className="w-6 h-6 rounded-none border-2 border-white dark:border-gray-900 bg-gray-100 dark:bg-black flex items-center justify-center text-xs font-medium text-gray-600 dark:text-gray-400">
                          +{project.members.length - 3}
                        </div>
                      )}
                    </div>
        ...
        {showNewProjectPopup && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-black rounded-none shadow-2xl border-2 border-gray-200 dark:border-gray-700 max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto"
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    {newProject.logo ? (
                      <div className="relative">
                        <img
                          ...
                          className="w-16 h-16 rounded-none object-cover border-2 border-gray-200 dark:border-gray-700"
                        />
                        <button
                          type="button"
                          onClick={() => setNewProject({...newProject, logo: null})}
                          className="absolute -top-2 -right-2 w-6 h-6 bg-red-500 text-white rounded-none flex items-center justify-center text-xs hover:bg-red-600"
                        >
                          <X className="w-3 h-3" />
                        </button>
                      </div>
                    ) : (
                      <div className="w-16 h-16 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-none flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <label
                        htmlFor="logo-upload"
                        className="cursor-pointer inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-none shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-black hover:bg-gray-50 dark:hover:bg-gray-700"
                      >
                          ...
                          >
                            <div className="flex items-center gap-3">
                              <img 
                                ...
                                alt={user.username}
                                className="w-8 h-8 rounded-none object-cover border-2 border-gray-200 dark:border-gray-700"
                              />
                              <div>
                  ...
                  {newProject.members.length > 0 && (
                    <div className="flex flex-wrap gap-2">
                      {newProject.members.map((member) => (
                        <span
                          key={member.id}
                          className="inline-flex items-center gap-1 px-3 py-1 bg-gray-100 dark:bg-black text-gray-800 dark:text-gray-200 rounded-none text-sm"
                        >
                          <img
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <span className={`inline-flex items-center gap-1 px-4 py-2 uppercase font-bold rounded-none text-xs font-medium ${getStatusColor(selectedProject.status)}`}>
                          {getStatusIcon(selectedProject.status)}
                          {selectedProject.status}
                        </span>
                      </div>
                      <div>
                        <span className={`inline-flex items-center gap-1 px-4 py-2 uppercase font-bold rounded-none text-xs font-medium ${getPriorityColor(selectedProject.priority)}`}>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedProject.tags.map((tag, index) => (
                            <span
                              key={index}
                              className="inline-flex items-center px-2 py-1 bg-gray-100 dark:bg-black text-gray-800 dark:text-gray-200 rounded-none text-xs"
                            >
                              {tag}
                            </span>
                          ))}
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="space-y-2 max-h-45overflow-y-auto" key={refreshKey}>
                        {selectedProject.members && selectedProject.members.length > 0 ? selectedProject.members.map((member, index) => (
                          <div key={`${member.user?._id || member.user?.id}-${index}-${refreshKey}`} className="flex items-center justify-between p-2 bg-gray-50 dark:bg-black rounded-none">
                            <div className="flex items-center gap-2">
                              <img
                                {...getAvatarProps(member.user?.avatar, member.user?.username)}
                                alt={member.user?.username}
                                className="w-8 h-8 rounded-none cursor-pointer hover:scale-110 transition-transform"
                    ...
                    <div>
                      <button
                        ...
                        className="flex items-center justify-between w-full cursor-pointer  text-left mb-4 hover:bg-gray-50 dark:hover:bg-gray-800 p-4 border rounded-none transition-colors"
                      >
                            ...
                            {selectedProject.links?.length > 0 ? (
                              selectedProject.links.map((link, index) => (
                                <motion.div 
                                  ...
                                  className="flex items-center justify-between p-2 bg-gray-50 dark:bg-black rounded-none"
                                >
                                  <div className="flex items-center gap-2">
                                  ...
                                  <a
                                    ...
                                    className="text-gray-500 hover:text-gray-600 text-sm w-[50px] h-[50px] border flex items-center justify-center rounded-none"
                                  >
                ...
                <div className="mt-6 grid grid-cols-1 lg:grid-cols-1 gap-6">
                  ...
                  <div>
                    <button
                      ...
                      className="flex items-center justify-between w-full text-left hover:bg-gray-50 cursor-pointer dark:hover:bg-gray-800 p-4 border rounded-none transition-colors"
                    >
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                          ...
                          {selectedProject.tasks?.length > 0 ? (
                            selectedProject.tasks.map((task, index) => (
                              <motion.div 
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ delay: index * 0.1 }}
                                className="flex items-center justify-between p-3 bg-gray-50 dark:bg-black rounded-none"
                              >
                                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <button
                      ...
                      className="flex items-center justify-between w-full text-left cursor-pointer mb-4 hover:bg-gray-50 dark:hover:bg-gray-800 p-4 border rounded-none transition-colors"
                    >
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-none appearance-none cursor-pointer"
                  />
                </div>
        ...
        {showMembersModal && selectedProject && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.9, opacity: 0 }}
              className="bg-white dark:bg-black rounded-none shadow-2xl border-2 border-gray-200 dark:border-gray-700 max-w-2xl w-full max-h-[80vh] overflow-y-auto"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    {showProjectMemberSuggestions && projectMemberSuggestions.length > 0 && (
                      <div className="mt-2 border border-gray-200 dark:border-gray-700 rounded-none bg-white dark:bg-black max-h-40 overflow-y-auto">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 max-h-60 overflow-y-auto" key={refreshKey}>
                      {selectedProject.members?.map((member, index) => (
                        <div key={`${member.user?._id || member.user?.id}-${index}-${refreshKey}`} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-black rounded-none">
                          <div className="flex items-center gap-3">
                            <img
                              {...getAvatarProps(member.user?.avatar, member.user?.username)}
                              alt={member.user?.username}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 max-h-60 overflow-y-auto">
                      {selectedProject.links?.map((link, index) => (
                        <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-black rounded-none">
                          <div className="flex items-center gap-3">
                            <Link className="w-4 h-4 text-gray-500" />
                            <div>
                              <p className="text-sm font-medium text-gray-900 dark:text-white">
