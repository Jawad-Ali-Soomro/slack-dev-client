            ...
            <div className="space-y-6">
              {[
                ...
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                >
                  <div className="w-[60px] h-[60px] bg-black rounded-[15px] flex items-center justify-center dark:bg-white">
            ...
            <form className="space-y-6">
              <div>
                <input
                  ...
                  className="w-full p-4 glass-card rounded-[15px] border-0 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400   text-sm"
                />
              </div>
              <div>
                <input
