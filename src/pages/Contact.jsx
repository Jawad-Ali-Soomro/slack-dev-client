          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-6">
              {[
                ...
                <motion.div
                  key={index}
                  className="glass-card p-6 rounded-[10px] flex items-center space-x-4"
                  whileHover={{ y: -5 }}
                >
                  <div className="w-[60px] h-[60px] bg-black rounded-[10px] flex items-center justify-center dark:bg-white">
