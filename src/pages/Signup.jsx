    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      ...
      >
        ...
        <motion.div
          ...
          className="p-5 md:p-8 md:shadow-2xl md:rounded-[15px] md:dark:border-gray-700"
        >
          {/* Header */}
          ...
          <motion.div variants={itemVariants} className="text-end mt-6">
            <p className="text-gray-600 dark:text-gray-300">
              ...
              <Link to="/login" className="px-15 dark:bg-white dark:text-black ml-3 py-4 font-bold rounded-[15px] text-white bg-black  text-sm uppercase ">
                Sign in
              </Link>
            </p>
          </motion.div>
