        ...
        >
                  ...
                  {otp.map((digit, index) => (
                    <div key={index} className="relative">
                      <input
                        ...
                        className="w-14 h-14 text-center text-2xl font-bold border-2 border-gray-200 dark:border-gray-700 rounded-lg focus:outline focus:outline-1 focus:outline-black focus:border-black dark:focus:outline-white dark:focus:border-white dark:bg-black dark:text-white"
                        autoComplete="off"
                      />
                      {index < 3 && (
          ...
          {step === 4 && (
            <motion.div variants={itemVariants} className="text-center space-y-6">
              ...
              <Link
                to="/login"
                className="inline-block w-full py-3 bg-black text-white rounded-lg font-bold hover:bg-black transition-colors text-center dark:bg-white dark:text-black dark:hover:bg-gray-200"
              >
                Back to Login
              </Link>
            </motion.div>
