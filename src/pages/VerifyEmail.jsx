        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <motion.button
              ...
              className="w-full py-3 bg-black dark:bg-white text-white dark:text-black rounded-lg font-bold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
