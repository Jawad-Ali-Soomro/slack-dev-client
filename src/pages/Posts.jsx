  ...
  return (
    <div>
      {/* Debug User Info */}
        ...
        <div className=" mx-auto flex items-centerjustify-between w-full flex-col relative">
          {/* Fixed Search and Create Post Header */}
        <div className="fixed top-16 left-0 right-3 z-40 bg-white dark:bg-black mt-4 border-gray-200 dark:border-gray-700 px-6 py-4 shadow-sm">
            <div className=" mx-auto">
              <div className="flex items-center  justify-end gap-4">
                ...
                <Button
                  ...
                  className="px-6 py-2 rounded-none flex items-center gap-2 w-[200px]"
                >
          ...
          {loading ? (
            ...
            posts.map((post) => (
              <motion.div
                ...
                exit={{ opacity: 0, y: -20 }}
                className="rounded-none shadow-sm border overflow-hidden flex flex-col bg-white dark:bg-black hover:shadow-md transition-shadow duration-200"
              >
                {/* Post Header */}
                <div className="p-4 bg-gray-100 dark:bg-[rgba(255,255,255,.1)] border-gray-200 dark:border-gray-700">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      <Avatar className="w-10 h-10 border p-1 rounded-none border dark:border-[rgba(255,255,255,.2)]">
                        <AvatarImage className={'rounded-none'} {...getAvatarProps(post.author.avatar, post.author.username)} />
                      ...
                      <div className='flex gap-5'>
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-500">
                          ...
                          {/* <div className="flex items-center gap-1">
                            <span className="capitalize px-4 py-2 bg-white text-[10px] font-bold text-black rounded-none">{post.visibility}</span>
                          </div> */}
                        </div>
                      </div>
                    </div>
...
{(() => {
                        ...
                        {post.images.slice(0, 4).map((image, index) => (
                          <div key={index} className="relative group">
                            <img
                              ...
                              className="w-full h-48 object-cover rounded-none border-2 cursor-pointer hover:opacity-90 transition-opacity"
                              onError={(e) => {
                            ...
                            {post.images.length > 4 && index === 3 && (
                              <div 
                                className="absolute inset-0 bg-[rgba(0,0,0,.7)] dark:bg-[rgba(0,0,0,.2)] bg-opacity-50 rounded-none flex items-center justify-center cursor-pointer"
                                onClick={() => navigate(`/post/${post._id}`)}
                              >
                  ...
                  {post.tags.length > 0 && (
                    <div className="flex flex-wrap gap-2 mt-4">
                      {post.tags.map((tag, index) => (
                        <Badge key={index} variant="outline" className="text-xs bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900 text-blue-800 dark:text-blue-200 rounded-none  px-4 py-2">
                          #{tag}
                        </Badge>
                      ))}
                    </div>
                ...
                {/* Post Actions */}
                <div className="px-4 py-3 border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-[rgba(255,255,255,.1)] mt-auto">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-none w-[50px] border transition-all duration-200 ${
                          isLiked(post) 
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() => navigate(`/post/${post._id}`)}
                        className="flex w-[50px] border  items-center gap-2 px-4 py-2 rounded-none text-gray-500 hover:text-blue-500 hover:bg-blue-50 hover:shadow-sm transition-all duration-200"
                      >
                      ...
                      <Button
                        ...
                        className="flex w-[50px] border  items-center gap-2 px-4 py-2 rounded-none text-gray-500 hover:text-green-500 hover:bg-green-50 hover:shadow-sm transition-all duration-200"
                      >
                      ...
                      <div className="p-6 space-y-4">
                        ...
                        <div className="flex gap-3 items-center mb-10">
                          <Avatar className="w-12 h-12 border border-gray-200 dark:border-gray-700 p-1">
                            <AvatarImage className={'rounded-none'} {...getAvatarProps(user.avatar, user.username)} />
                        ...
                        {post.comments.slice(0, visibleComments[post._id] || 3).map((comment) => (
                          <div key={comment._id} className="flex gap-3 relative overflow-hidden rounded-none">
                            ...
                            <div className="flex-1">
                              <div className="bg-gray-100 dark:bg-[rgba(255,255,255,.1)] rounded-none p-3 px-5 mt-8">
        ...
        {showCreateModal && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-black border rounded-noneshadow-xl w-full  max-w-xl border-gray-200 dark:border-gray-700 max-h-[90vh] overflow-y-auto"
                ...
                <div>
                  ...
                  <div className="flex gap-2 mb-4">
                    ...
                    <label
                      ...
                      className="flex-1 p-3 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-none cursor-pointer hover:border-blue-500 transition-colors"
                    >
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-2 mt-3">
                        {selectedFiles.map((file, index) => (
                          <div key={index} className="flex items-center gap-2 bg-gray-100 dark:bg-gray-700 px-3 py-2 rounded-none">
                        ...
                        {newPost.images.map((image, index) => (
                          <div key={index} className="relative group">
                            ...
                            <button
                              ...
                              className="absolute top-2 right-2 bg-red-500 text-white rounded-none p-1 opacity-0 group-hover:opacity-100 transition-opacity"
                            >
                              <X className="w-3 h-3" />
                            </button>
                          </div>
