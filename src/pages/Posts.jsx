            ...
            <div className=" mx-auto">
              <div className="flex items-center  justify-end gap-4">
                ...
                <Button
                  ...
                  className="px-6 py-2 rounded-[25px] flex items-center gap-2 w-[200px]"
                >
          ...
          {loading ? (
            ...
            posts.map((post) => (
              <motion.div
                ...
                exit={{ opacity: 0, y: -20 }}
                className="rounded-[25px] shadow-sm border overflow-hidden flex flex-col bg-white dark:bg-black hover:shadow-md transition-shadow duration-200"
              >
                {/* Post Header */}
        ...
        {showCreateModal && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-black border rounded-[25px]shadow-xl w-full  max-w-xl border-gray-200 dark:border-gray-700 max-h-[90vh] overflow-y-auto"
