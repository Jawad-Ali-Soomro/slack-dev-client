                    ...
                    <div className="relative w-full h-[350px] bg-gray-100 dark:bg-gray-800 overflow-hidden">
                      <img
                        src={(() => {
                          ...
                          return path ? `${base}${path.startsWith("/") ? path : `/${path}`}` : "";
                        })()}
                        alt={project.title}
      ...
      {showProjectModal && selectedProject && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-gray-900 rounded-[15px] p-6 md:p-8 max-w-6xl w-full flex flex-col shadow-2xl overflow-hidden"
          ...
          >
            <div className="flex-shrink-0 flex  gap-4  pb-2">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <Badge className="bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-200 px-3 py-1 rounded-[15px] text-xs font-semibold">
            ...
            <div className="flex text-justify max-w-[70%] line-clamp-2 icon">
              <p className="line-clamp-2 icon">{selectedProject.description}</p>
            </div>
