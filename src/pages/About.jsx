      ...
      >
        ...
        >
          {[
            ...
            >
              <div
                className="text-4xl  text-black mb-2 dark:text-white"
                style={{
                  fontWeight: 900,
                }}
              >
              ...
              <div
                className="text-gray-600 dark:text-gray-300  text-[15px] "
                style={{
                  fontWeight: 800,
                }}
              >
        ...
        <motion.section variants={itemVariants} className="text-center mb-20">
          ...
          <p className="text-lg max-w-4xl mx-auto  leading-relaxed">
            To empower developers worldwide with cutting-edge tools and
            ...
            {[
              {
                ...
                description:
                  "We prioritize our developer community and build features based on real feedback.",
                image:
                  "https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?w=1800&h=900&fit=crop",
              },
              {
                icon: <Target />,
                title: "Innovation Driven",
                description:
                  "We constantly push the boundaries of what's possible in developer tools.",
                image:
                  "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1800&h=900&fit=crop",
              },
              {
                icon: <Award />,
                ...
                image:
                  "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=1800&h=900&fit=crop",
              },
              {
                icon: <Globe />,
                title: "Globally Accessible",
                description:
                  "We ensure our platform is accessible to developers worldwide, regardless of location.",
                image:
              ...
              >
                ...
                <div className="w-[80px] h-[80px] bg-black rounded-[15px] flex items-center justify-center mb-6 dark:bg-white">
