...
export const codeCollaborationService = {
  ...
  getSessionById: async (sessionId) => {
    try {
      const response = await axiosInstance.get(
        `/api/code-collaboration/${sessionId}`,
      );
      return response.data;
    } catch (error) {
  ...
  getUserSessions: async (page = 1, limit = 10) => {
    try {
      const response = await axiosInstance.get(
        `/api/code-collaboration/user/sessions?page=${page}&limit=${limit}`,
      );
      return response.data;
    } catch (error) {
  ...
  getPublicSessions: async (page = 1, limit = 10, language = null) => {
    try {
      ...
      const response = await axiosInstance.get(
        `/api/code-collaboration/public/sessions?${params}`,
      );
      return response.data;
    } catch (error) {
  ...
  joinSession: async (sessionId) => {
    try {
      const response = await axiosInstance.post(
        `/api/code-collaboration/${sessionId}/join`,
      );
      return response.data;
    } catch (error) {
  ...
  leaveSession: async (sessionId) => {
    try {
      const response = await axiosInstance.post(
        `/api/code-collaboration/${sessionId}/leave`,
      );
      return response.data;
    } catch (error) {
  ...
  updateCode: async (sessionId, code, cursorPosition = null) => {
    try {
      const response = await axiosInstance.put(
        `/api/code-collaboration/${sessionId}/code`,
        {
          code,
          cursorPosition,
        },
  ...
  updateCursor: async (sessionId, cursorPosition) => {
    try {
      const response = await axiosInstance.put(
        `/api/code-collaboration/${sessionId}/cursor`,
        {
          cursorPosition,
        },
      );
  ...
  getSessionStats: async () => {
    try {
      const response = await axiosInstance.get(
        "/api/code-collaboration/stats/overview",
      );
      return response.data;
    } catch (error) {
  ...
  endSession: async (sessionId) => {
    try {
      const response = await axiosInstance.put(
        `/api/code-collaboration/${sessionId}/end`,
      );
      return response.data;
    } catch (error) {
  ...
  generateInviteCode: async (sessionId) => {
    try {
      const response = await axiosInstance.post(
        `/api/code-collaboration/${sessionId}/invite-code`,
      );
      return response.data;
    } catch (error) {
  ...
  joinByInviteCode: async (inviteCode) => {
    try {
      const response = await axiosInstance.post(
        `/api/code-collaboration/join/${inviteCode}`,
      );
      return response.data;
    } catch (error) {
  ...
  inviteUser: async (sessionId, invitedUserId) => {
    try {
      const response = await axiosInstance.post(
        `/api/code-collaboration/${sessionId}/invite`,
        {
          invitedUserId,
        },
      );
