...
const completionService = {
  ...
  markMeetingCompleted: async (meetingId) => {
    try {
      const response = await axios.post(
        `/api/completions/meetings/${meetingId}`,
      );
      return response.data;
    } catch (error) {
  ...
  markProjectMilestoneCompleted: async (projectId, milestoneId) => {
    try {
      const response = await axios.post(
        `/api/completions/projects/${projectId}/milestones/${milestoneId}`,
      );
      return response.data;
    } catch (error) {
  ...
  isTaskCompleted: async (taskId) => {
    try {
      const response = await axios.get(
        `/api/completions/tasks/${taskId}/status`,
      );
      return response.data;
    } catch (error) {
  ...
  isMeetingCompleted: async (meetingId) => {
    try {
      const response = await axios.get(
        `/api/completions/meetings/${meetingId}/status`,
      );
      return response.data;
    } catch (error) {
  ...
  getCompletionHistory: async (filters = {}) => {
    try {
      const response = await axios.get("/api/completions/history", {
        params: filters,
      });
      return response.data;
    } catch (error) {
